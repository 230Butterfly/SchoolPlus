...
public class Recy_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Recy_adapter(ArrayList<Near_resource_information> mPost, Context mContext) {
        this.mPost = mPost;
...
//        }
        ...
        holder1.mark.setText(String.valueOf(mPost.get(position).getResource_grade() )+ "分");
